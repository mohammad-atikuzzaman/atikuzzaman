    ...
    <div className="max-w-3xl mx-auto px-6 text-gray-800">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
        <p className="flex items-center gap-2">
          <IoIosCalendar className="text-blue-500" /> <b>Birthday:</b> 10
          November 2001
        </p>
        <p className="flex items-center gap-2">
        ...
        <p className="flex items-center gap-2">
          <LuUniversity className="text-blue-500" /> <b>University:</b> National
        ...
        <p className="flex items-center gap-2">
          <MdOutlineAttachEmail className="text-blue-500" /> <b>Email:</b>{" "}
          akash203037@gmail.com
        </p>
        <p className="flex items-center gap-2">
          <FaTreeCity className="text-blue-500" /> <b>Address:</b> Pabna,
          Bangladesh
        </p>
        <p className="flex items-center gap-2">
